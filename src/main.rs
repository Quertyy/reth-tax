...
use reth::revm::primitives::{Env, ResultAndState, TxEnv, AccountInfo, U256, Bytecode, TransactTo};
    ...
    Eth: EthTransactions + 'static
{
    async fn token_tax(&self, addresses: Vec<Address>) -> RpcResult<Vec<TaxCallResult>> {
        ...
        let res = self.eth_api
            ...
            let controller_account = AccountInfo::new(U256::from(69), 0, KECCAK_EMPTY, Bytecode::default());
            ...
            env.tx.gas_price = U256::from(1000000000);
            ...
            while let Some(token) = addresses.next() {
                ...
                evm.env.tx.transact_to = TransactTo::Call(tax_checker_controller_address());
